...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "Blockstart",
    body: "Tracking platform for track athletes and coaches: meets, results and progression in one place, usable on a phone in the rain.",
  ...
  },
  {
    ...
    kind: "Brand website",
    title: "Just Shirley",
    body: "Front-end and brand site for a sparkling beverage. The rare build where the hardest problem was kerning.",
...
export const ROLES: Role[] = [
  {
    ...
    role: "swe intern",
    accent: true,
    body: "Systems and platform work on a team shipping to an enormous number of devices — and a fast education in what code review looks like when the blast radius is that big.",
    tags: ["systems", "platform", "internal tooling"],
  },
  {
    when: "2025",
    sha: "7b02de1",
